...
import myProductions from '../../data/myProductions';

const Productions = () => {
  // Create audio references dynamically based on the myProductions array
  const audioRefs = useRef(myProductions.map(original => new Audio(original.song)));
    ...
    <div className="relative min-h-screen flex flex-col overflow-hidden">
      ...
      <div className="w-full">
        ...
        <div className='container mx-auto p-10 mt-10'>
          <h1 className='text-8xl text-white font-extrabold tracking-tight shadow-xl font-customOne'>My Productions</h1>
        </div>
        <div className="container mx-auto pt-12">
          <div className="flex flex-wrap justify-items -m-4">
            {myProductions.map((work, index) => (
